...
{
       0,    52,    52,    52,    53,    53,    56,    56,    59,    61,
      62,    66,    69,    80,    83,    85,   102,   103,   135,   152,
     184,   187,   191,   192,   197,   218,   243,   269,   296,   308,
     320,   332,   344,   353,   356,   368
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "PRINT", "READ", "LPAREN", "RPAREN", "LKEY", "RKEY",
  "SEMICOLON", "COMMA", "EQUALOP", "PLUSOP", "MINUSOP", "ASTERISKOP",
  "SLASHOP", "MINUSOP2", "ID", "NUM", "STRING", "$accept", "program",
  "$@1", "declarations", "$@2", "$@3", "identifier_list", "asig",
...
{
       2,    -7,    20,    28,   -28,    42,    53,   -28,   -28,     5,
     -28,   -28,    -2,    61,    61,    74,    75,    17,    64,   -28,
     -28,    71,   -28,    72,    14,   -28,    31,    26,    26,    26,
      26,   -28,   -28,   -28,    37,   -28,    60,   -28,    57,     9,
      26,    26,   -28,    61,   -28,    39,    44,    49,   -28,   -28,
      17,    26,    26,    26,    26,   -28,    67,   -28,    56,    60,
     -28,    25,    25,   -28,   -28,    62,    62,   -28,   -28,   -28,
     -28,    84,   -28,    25,   -28
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,    34,    35,    25,     0,    22,    24,    26,     0,     0,
       0,     0,     5,     0,     7,     0,     0,     0,    32,    20,
...
{
      45,    46,    47,    48,    15,     1,    16,    17,    18,    10,
      11,    19,    20,    58,    59,    15,     3,    16,    17,    18,
       4,    21,    19,    57,    65,    66,    67,    68,    29,    42,
      43,    15,    21,    16,    17,    18,    30,    29,    19,     5,
      31,    32,    33,    71,    72,    30,    44,    43,    21,    31,
      32,    61,    49,    50,     6,    74,    62,    51,    52,    53,
      54,    63,    51,    52,    53,    54,     7,    51,    52,    53,
      54,    70,    55,    56,    51,    52,    53,    54,    51,    52,
      53,    54,    53,    54,    23,    27,    28,    37,    40,    41,
      69,    73,    26,    60,     0,    39,    64
};

static const yytype_int8 yycheck[] =
{
      27,    28,    29,    30,     6,     3,     8,     9,    10,     4,
       5,    13,    14,    40,    41,     6,    23,     8,     9,    10,
       0,    23,    13,    14,    51,    52,    53,    54,    11,    15,
      16,     6,    23,     8,     9,    10,    19,    11,    13,    11,
      23,    24,    25,    61,    62,    19,    15,    16,    23,    23,
      24,    12,    15,    16,    12,    73,    12,    18,    19,    20,
      21,    12,    18,    19,    20,    21,    13,    18,    19,    20,
      21,    15,    15,    16,    18,    19,    20,    21,    18,    19,
      20,    21,    20,    21,    23,    11,    11,    23,    17,    17,
      23,     7,    14,    43,    -1,    19,    50
};
...
{
       0,     3,    27,    23,     0,    11,    12,    13,    28,    29,
       4,     5,    34,    30,    31,     6,     8,     9,    10,    13,
      14,    23,    35,    23,    32,    33,    32,    11,    11,    11,
      19,    23,    24,    25,    36,    37,    39,    23,    38,    34,
      17,    17,    15,    16,    15,    39,    39,    39,    39,    15,
      16,    18,    19,    20,    21,    15,    16,    14,    39,    39,
      33,    12,    12,    12,    37,    39,    39,    39,    39,    23,
      15,    35,    35,     7,    35
};
...
#line 1410 "miniC.tab.c"
  ...
  case 3:
#line 52 "miniC.y"
                                                                                             { imprimirTablaS(); concatenaLC((yyvsp[-2].codigo),(yyvsp[-1].codigo)); imprimirCodigo((yyvsp[-2].codigo)); liberaLS(tablaSimb); liberaLC((yyvsp[-2].codigo));}
...
#line 1464 "miniC.tab.c"
  ...
  case 11:
#line 66 "miniC.y"
                   { if (!perteneceTablaS((yyvsp[0].lexema))) anadeEntrada((yyvsp[0].lexema),tipo);
			else { printf("Error en la linea %d : variable %s ya declarada\n", yylineno, (yyvsp[0].lexema)); esemanticos++; } 
				(yyval.codigo) = creaLC();											}
#line 1472 "miniC.tab.c"
  ...
  case 12:
#line 69 "miniC.y"
                                        { if (!perteneceTablaS((yyvsp[-2].lexema))) anadeEntrada((yyvsp[-2].lexema),tipo);
						else { printf("Error en la linea %d : variable %s ya declarada\n", yylineno, (yyvsp[-2].lexema)); esemanticos++; } 
						(yyval.codigo) = (yyvsp[0].codigo);
						Operacion oper;
						oper.op = "sw";
						oper.res = recuperaResLC((yyvsp[0].codigo));
						oper.arg1 = concatena_((yyvsp[-2].lexema),"_");
						oper.arg2 = NULL;
...
#line 85 "miniC.y"
								...
								{ printf("Error en la linea %d : variable %s no declarada\n", yylineno, (yyvsp[-3].lexema)); esemanticos++; (yyval.codigo) = creaLC();}
							...
							else
								{
									...
									oper.arg1 = concatena_((yyvsp[-3].lexema),"_");
									oper.arg2 = NULL;
									insertaLC((yyval.codigo), finalLC((yyval.codigo)), oper);
									liberarReg(oper.res);								}																			
							}
...
#line 103 "miniC.y"
					...
					Operacion oper2;
					oper2.op = "beqz";
					oper2.res = recuperaResLC((yyval.codigo));
...
#line 152 "miniC.y"
					...
					Operacion oper3;
					oper3.op = "beqz";
					oper3.res = recuperaResLC((yyvsp[-2].codigo));
...
#line 243 "miniC.y"
                   { if (!perteneceTablaS((yyvsp[0].lexema)))
								{ printf("Error en la linea %d : variable %s no declarada\n", yylineno, (yyvsp[0].lexema)); esemanticos++; (yyval.codigo)=creaLC();}
								...
								{ printf("Error en la linea %d : identificador %s es constante\n", yylineno, (yyvsp[0].lexema)); esemanticos++; (yyval.codigo)=creaLC();}
									...
									Operacion oper3;	
									oper3.op = "sw";
									oper3.res = recuperaResLC((yyval.codigo));
									oper3.arg1 = concatena_((yyvsp[0].lexema),"_");
									oper3.arg2 = NULL;
									insertaLC((yyval.codigo),finalLC((yyval.codigo)),oper3);														}																									
																															}
...
#line 1854 "miniC.tab.c"
  ...
  case 34:
#line 356 "miniC.y"
                     { if (!perteneceTablaS((yyvsp[0].lexema))) { printf("Error en la linea %d : variable %s no declarada\n", yylineno, (yyvsp[0].lexema)); esemanticos++; (yyval.codigo)=creaLC(); guardaResLC((yyval.codigo),"");} 
				else {
						(yyval.codigo) = creaLC();
						Operacion oper;
						oper.op = "lw";
						oper.res = obtenerReg();
						oper.arg1 = concatena_((yyvsp[0].lexema), "_");
						oper.arg2 = NULL;
						insertaLC((yyval.codigo), finalLC((yyval.codigo)), oper);
						guardaResLC((yyval.codigo),oper.res);
						}
